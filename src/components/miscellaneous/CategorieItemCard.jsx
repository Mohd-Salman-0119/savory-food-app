...
const CategorieItemCard = () => {
  return (
    <div className="flex flex-col justify-center p-3 h-min items-center rounded-xl shadow-sm shadow-gray w-max">
      <div>
        ...
        <div className="flex flex-col gap-3 mt-2 items-center">
          ...
          <IconButton
            icon={faAngleRight}
            className="bg-red bg-primary text-white rounded-[50%] px-1"
          />
        </div>
      </div>
    </div>
